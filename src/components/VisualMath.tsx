  ...
  useEffect(() => {
    ...
    formulas.forEach((raw, i) => {
      ...
      try {
        ...
        // Fallback: show raw string in a code block
        const pre = document.createElement('pre');
        pre.style.cssText = 'font-family:monospace;font-size:14px;color:var(--ink);white-space:pre-wrap;margin:0';
        pre.textContent = raw;
  ...
  return (
    <div style={{ width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      <style>{`
        ...
        /* Override katex display block centering to left-align within card */
